...
<![endif]-->
                <div class='dys-column-per-100 outlook-group-fix' style='direction:ltr;display:inline-block;font-size:13px;text-align:left;vertical-align:top;width:100%;'>
                  <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='vertical-align:top;' width='100%'>
                    <tr>
                      <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                      <div style='font-family:Open Sans, Arial, sans-serif;font-size:22px;font-weight:bold;line-height:20px;text-align:center;text-transform:uppercase;'>
                          OfertasApp
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td align='center' style='font-size:0px;padding:10px 25px;padding-top:20px;word-break:break-word;'>
                        <div style='color:#0C3068;font-family:Courier New, Arial, sans-serif;font-size:40px;line-height:40px;text-align:center;text-transform:uppercase;'>
                              Se ha activado su usuario
                        </div>
                      </td>
                    </tr>
                  </table>
                    ...
                    <tr>
                      <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                        <div style='color:#999999;font-family:Open Sans, Arial, sans-serif;font-size:15px;line-height:22px;text-align:center;'>
                          <strong>Ya puede acceder a la plataforma OfertasApp y disfrutar de ella. Cualquier duda pongase en contacto con nosotros</strong>
                        </div>
                      </td>
                    </tr>
                  </table>
                                    ...
                                    <tr>
                                        <td align='center' style='font-size:0px;padding:5px;word-break:break-word;'>
                                            <div style='color:#848789;font-family:Open Sans, Arial, sans-serif;font-size:12px;line-height:18px;text-align:center;text-transform:uppercase;'>
                                                ...
                                                <p> Av. Andalucía S/N 21006 Huelva</p>
                                                <p> Llámenos ahora: 959 524 177</p>
                                                <p> Contacte por WhatsApp: 662032229</p>
                                                <p> admin@ofertasapp.es</p>
                                            </div>
                                        </td>
                                      <td align='center' style='font-size:0px;padding:5px;word-break:break-word;'>
                                        <div style='color:#848789;font-family:Open Sans, Arial, sans-serif;font-size:12px;line-height:18px;text-align:center;text-transform:uppercase;'>
                                          ©{{date('Y')}} OfertasApp S.L. Todos los derechos reservados.
                                        </div>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td align='center' style='font-size:0px;padding:5px;word-break:break-word;'>
                                        <div style='color:#848789;font-family:Open Sans, Arial, sans-serif;font-size:12px;line-height:18px;text-align:center;text-transform:uppercase;'>
                                          Por favor, no responda a este correo, se ha generado automáticamente.
